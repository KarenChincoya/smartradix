...
@Component({
  selector: 'app-env-humidity-chart',
  templateUrl: './env-humidity.component.html',
  styleUrls: ['./env-humidity.component.scss']
})
export class ChartEnvHumidityComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.reportsSub = this.reportsService.getReportUpdateListener()
      .subscribe((reports: Report[]) => {
        ...
        this.values = this.reportsService.getLastReportsEnvHumidity();
